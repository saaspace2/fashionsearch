...
def cells():
    ...
    yield {
        ...
        "source": [
            ...
            "#\n",
            "# 5.0 renamed the Swin attention layers — attention.self.query became\n",
            "# attention.q_proj, intermediate.dense became mlp.fc1, and so on. The\n",
            "# published checkpoint uses the 4.x names, so under 5.x the weights\n",
            "# silently DO NOT LOAD: you get 'copying to a meta parameter, no-op'\n",
            "# warnings, a randomly initialised encoder, and embeddings that look\n",
            "# fine and mean nothing.\n",
            "!pip install -q 'transformers<5' 'datasets<4' huggingface_hub pyarrow\n",
            "\n",
